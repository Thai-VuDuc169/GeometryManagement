...
class Edge 
{
    ...
    public:
        ...
        void reload_E(shape* ref1, shape* ref2)
        {
            this->shape_ref1 = ref1;
            this->shape_ref2 = ref2;
            cout << "\n\t\t\t\t\t\t^^^^^^^^=======^^^^^^^^" <<endl;
            cout << "\nNhap vao thong so duong noi tam cua hinh: " ; this->shape_ref1->get_i();
            cout << "\nVa cua hinh: "; 
            this->shape_ref2->get_i(); 

            cout << "\nMau cua duong noi tam: ";
            fflush(stdin) ; cin >> E_color;
            cout << "\nDo day mong cua duong noi tam: "; 
            fflush(stdin);cin >> E_thickness;
            float x1 = ref1->get_x();                       // tai sao ko dung dc kieu float& ??
            float y1 = ref1->get_y();
            float x2 = ref2->get_x();
            float y2 = ref2->get_y();
        ...
        void get_E_i()
        {
            // print thong so cua cac duong noi tam cua cac hinh
            cout << "\n\n\t\t\tDuong noi tam cua hai hinh: ";
            shape_ref1->get_i();
            cout << "\nVa cua hinh: " ; shape_ref2->get_i();
        ...
        // friend ostream operator<< (const ostream& out, Edge temp )
        // {
        //     out << temp.E_distance;
        //     return out;
        // } 
...
set<Edge *> edge_set;
/////////////////////////////////////////////////////////////////////////////////////////// thao tac trong menu
void reload_set(vector<shape*> vec)                                             
        {
            vector<shape*> ::iterator it = vec.begin(),jt;
            for ( ; it != vec.end() ; ++it)           /// Không hiểu ?
            {
                ...
                {   
                    ...
                    shape* temp2 = *jt;
                    Edge* temp;
                    temp->reload_E(temp1,temp2);
                    edge_set.insert(temp);
                }
            }
        };
void get_set_i()
        {
            cout << "\n======================================================" <<endl;
            cout << "Danh sach cac duong noi tam la: ";
            cout << "\n======================================================\n\n\n" <<endl;
